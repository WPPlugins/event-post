...
Tags: Post, posts, event, events, ics, ical, date, geolocalization, coordinates, gps, widget, map, openstreetmap, calendar, agenda, weather, multisite, native
...
[event-post.com](http://event-post.com/)
...
[End users documentation](https://wordpress.org/plugins/event-post/other_notes/)

[Plugins/themes developpers documentation](http://event-post.com/docs/)
